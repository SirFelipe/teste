...
class AnimalTableViewController: UITableViewController {
    ...
    var animal = ["Urso", "Girafa", "Elefante"]
    var foto = [#imageLiteral(resourceName: "urso"), #imageLiteral(resourceName: "girafa"), #imageLiteral(resourceName: "ele")]
    var pais = ["Canada", "Congo", "Tanzânia"]
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let t = segue.destination as! InfoViewController
        t.nomeAnimal = animal[indice]
        t.fotoAnimal = foto[indice]
        t.paisAnimal = pais[indice]
    }
